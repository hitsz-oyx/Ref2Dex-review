...
- V1.16.4：`3×128` 运行中 peak 为 GPU0/1/3=`16440/14137/15358 MiB`；V1.16.3 的 PPO worker 正常完成，但 runner 把 `Popen.wait()` 的整数误当作 `CompletedProcess` 而未做终态 validation。现已修正并复跑相同 budget；算法、输入、buffer、奖励与 critic 合同不变，尚不尝试 `3×256`。
