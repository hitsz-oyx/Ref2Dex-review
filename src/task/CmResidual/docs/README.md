...
- `work_version`: `V1.21`
- V1.21：用户已批准仅执行 V1.19 streaming Cm-on 工程 smoke，随后在同一单卡上进行从零初始化的 10-epoch `cm_distill_coef=0` reference-PPO Phase A。Cm distillation Phase B、长 horizon 与抓取结论均未授权；详见 [V1.21 最终计划](plan/V1.21.md)。
