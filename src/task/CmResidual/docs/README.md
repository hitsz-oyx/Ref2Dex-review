...
- `work_version`: `V1.21`
- V1.21：Phase 0 Cm-on engineering smoke 与从零初始化的 10-epoch `cm_distill_coef=0` reference-PPO Phase A 均已完成；用户已授权按 [V1.21a](plan/V1.21a.md) 从明确 pin 的 Phase-A checkpoint 运行 10-epoch `cm_distill_coef=0.10` Phase B。长 horizon、online planner、Cmv2 fine-tune 与抓取结论仍未授权。
