...
DEFAULT_CONFIG = "src.task.corresponse_v1.config:Config"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the StaticHOCNet correspondence model.")
...
def main() -> None:
    ...
    CorrResponseRunner(cfg, mode="train").run()
