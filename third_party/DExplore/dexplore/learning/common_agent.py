"""CommonAgent: base RL training agent built on top of rl_games A2C."""
...
class CommonAgent(a2c_continuous.A2CAgent):
    ...
    # ----------------------------------------------------------------
    # Gradient computation and loss functions
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # Configuration and setup (private)
    # ----------------------------------------------------------------
