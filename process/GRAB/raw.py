...
class GRABRawAdapter:
    ...
    def _empty_hand_payload(self, T: int) -> dict:
        return {
            ...
            "vertices": np.zeros((T, 0, 3), dtype=np.float32),
    ...
    def process_sequence(self, seq_path: str) -> dict:
        ...
        output = {
            ...
            "right_hand_mesh_vertices_world": right_data["vertices"],
            "right_hand_mesh_faces": right_data["faces"],
            ...
            "left_hand_mesh_vertices_world": left_data["vertices"],
            "left_hand_mesh_faces": left_data["faces"],
